# Sample Solutions for Requirements Analysis Exercise B

There are many possible criteria for evaluating requirements as good or bad.

In this problem, we will evaluate based on the 7 requirement quality attributes previously presented by Denger et
al. [2] and Genova et al. [3], and applied in the study by Ronaki et al. (2023) [1]. These quality attributes include:
